...
namespace ShellExtension
{
    ...
    public sealed class ShellInterop
    {
        ...
        */
        ...
        HChangeNotifyEventID eventID,
        HChangeNotifyFlags flags,
        IntPtr item1,
        IntPtr item2);
    ...
    public class MyIconOverlay : IShellIconOverlayIdentifier
    {
        ...
        private static string GUID = "{B8FA9E43-38E6-4654-8A13-FF905AD22CE5}";
        ...
        static void RegisterServer(String zRegKey)
        {
            ...
            System.IO.File.AppendAllText("f:\\reg_iconoverlay.txt", "OUTOUT");
            try
            {
                RegistryKey root;
                RegistryKey rk;
                ...
                rk = root.OpenSubKey(@"Software\Microsoft\Windows\CurrentVersion\Explorer\ShellIconOverlayIdentifiers", true);
                rk.CreateSubKey("TestExt").SetValue(string.Empty, "{B8FA9E43-38E6-4654-8A13-FF905AD22CE5}");
                //rk.SetValue(string.Empty, "{B8FA9E43-38E6-4654-8A13-FF905AD22CE5}");
                rk.Close();
            }
            catch (Exception e)
            {
